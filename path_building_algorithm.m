while true
    ...
    % between.
    c=10;
    y0(2)=randi([0,min([y0(1),y0(3)])])-c;
    y0(4)=randi([0,min([y0(3),y0(5)])])-c;
    y0(6)=randi([0,min([y0(5),y0(7)])])-c;
    y0(8)=randi([0,min([y0(7),y0(9)])])-c;
    y0(10)=randi([0,min([y0(9),y0(11)])])-c;
    ...
    vars = polyfit(x0,y0,length(y0));
    plot(0:.1:300,polyval(vars,0:.1:300))
    hold on;
    plot(x0,y0, "o")
